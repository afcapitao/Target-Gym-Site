    ...
    >
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 text-center pt-20">
        ...
        >
          Treina Como
          <br />
          <span className="text-[#e61f1f]">Um Campeão</span>
        </h1>
        ...
        <p className="text-lg sm:text-xl text-white/70 max-w-2xl mx-auto mb-10 leading-relaxed opacity-0 animate-[fadeInUp_0.8s_ease_0.7s_forwards]">
          Personal training de elite no coração de Lisboa. Resultados reais,
          metodologias comprovadas e treinadores certificados ao teu lado em
          cada repetição.
        </p>
